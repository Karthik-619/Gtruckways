...
<!--    <span style="margin-left:20%;font-size:15px;"> <a href="maptest.jsp"><i class="fa fa-map-marker"></i><b>Status of truck</b></a></span>
 -->     <ul class="side-nav" id="mobile-demo">
     <li> <img src="img/gtlogo.jpg" class="logo1"  alt="" /></li>
       ...
       <div class="right">
        <span><b>Vehicle RegNo</b>:${TripDetails.bookingId}</span><br>
       ...
       <span><b>Total Time</b>:${liveinfo.timeMins}&nbsp;mins</span>
        ...
        // we are receiving a lat and long values in jsp page here	 
        	   ...
        	   for (var j = 1; j <  markerLat.length-1; j=j+3) {
                ...
                directionsService.route(request, function (response, status) {
                    ...
                    if (status == google.maps.DirectionsStatus.OK) {
                        ...
                        // For each route, display summary information. // here i will calculate distance
