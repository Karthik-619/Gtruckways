...
input[name="totalAmount"] {
	...
	<div class="row col s12 m12 l12 note center" ><b >Note:The price is an approximate  and it excludes GST</b></div>
...
<div class="row">
<img src="img/Untitled-1.png" width="100%" height="200px" class="circle">
</div>
</c:when>
...
<div class="card col s12 m12 l4">
	<div class="card-content">
		<div class="card-title">
			<div style="color:#0a6ed2;font-family:Rockwell, 'Courier Bold', Courier, Georgia, Times, 'Times New Roman', serif;" class="center">User Information</div>
 ...
 <div class="row">
			...
			<label for="date_foo" ></label>
			 ...
			 $('#date_foo').appendDtpicker({
				 ...
				 de.setDate(de.getDate() + 7);//current date+7days
					 	...
					 	$('#date_foo').handleDtpicker('setMaxDate', de);  */ 
	...
	<!-- <div class="row">
		...
		<span class="fa fa-map-marker"></span>
		 <textarea  name="pickupArea" class="text_content" style="height:50px;font-family: Roboto, sans-serif;" maxlength="150" placeholder="Pickup point" ></textarea>
		</div>
		<div class="input-fiels col s12 l6  map-marker">
				 <span class="fa fa-map-marker"></span>
		 <textarea cols="12" rows="12" name="dropArea" style="height:50px;font-family: Roboto, sans-serif;" maxlength="150" class="text_content" placeholder="Drop point" ></textarea>
		</div>					
		</div>
...
<div class="row ">
<!-- <div class=" center black-text " style="background-color:rgb(153, 204, 255); padding:3px;;border:1px solid black;  border-radius:10px;" >Total Price&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span  class="" style="font-size:12px;cursor:pointer;"><i class="fa fa-info-circle"></i><a href="#modal3" class=" modal-trigger black-text" ><u>View Price Chart</u></a></span> </div>
 --><br>
 <span id="promomsg1" style="font-size:13px;margin-left:8rem;margin-top:-2rem;"></span>
<div class="row">
...
<%-- <span class="col push-l3 black-text" style="padding:0px;font-size:20px;">Total Price:<br> <span style="font-size:px;">RS.</span>${priceinfo.totalAmount}</span>
...
<%--  <div class="inr" id="total1">
  <span class="fa fa-inr"></span>
  <input type="text" name="totalAmount" id="amount" value=" ${priceinfo.totalAmount}" readonly>
  <span id="menu_link" class="col push-l4"><i class="fa fa-info-circle"></i><u>View Price Details</u></span> 
  <input type="hidden" name="amount" id="amountid" value="${priceinfo.totalAmount}"/> 
  </div> --%>
...
<!-- <div class="promo input-field  offset-l3 " >
<input type="text" name="promoCode" id="promocodeId" placeholder="Enter Promocode"  style="font-size:12px;"class="validate" >
