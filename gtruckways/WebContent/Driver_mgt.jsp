...
<!--    <span style="margin-left:20%;font-size:15px;"> <a href="maptest.jsp"><i class="fa fa-map-marker"></i><b>Status of truck</b></a></span>
 ...
 <li><a href="postID">Go Back</a></li>
  ...
  <div class="stepbar">
		...
		<div class="stepbox"><a href="Track_Driver.jsp" id="livetracking"><div class="stepS e-daily"><i class="fa fa-calendar" style="color:white;font-size:20px;"></i></div><b>Live Tracking</b></a></div>
